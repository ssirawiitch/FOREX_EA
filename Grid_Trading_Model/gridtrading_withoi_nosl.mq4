...
// manage stop-loss
// and dynamic lot size
//ตัวกรองสภาวะตลาด (Market Condition Filters): พิจารณาเพิ่มตัวกรองเพื่อป้องกันไม่ให้ EA เปิดออเดอร์ในช่วงที่ตลาดมีแนวโน้มแข็งแกร่ง ตัวอย่างเช่น ใช้ Average Directional Index (ADX) เพื่อวัดความแข็งแกร่งของแนวโน้ม หรือ Ichimoku Cloud เพื่อระบุแนวโน้มที่แข็งแกร่ง EA อาจหยุดเปิดออเดอร์ใหม่เมื่อตรวจพบแนวโน้มที่แข็งแกร่ง และจะกลับมาทำงานอีกครั้งเมื่อตลาดกลับมาอยู่ในสภาวะแกว่งตัว
